...
\newenvironment{for_you}[1]{%
    \tcbset{
        ...
        bottom=3pt,
        fonttitle=\bfseries,
        title=#1, % <-- Ici, #1 est remplacé par l'argument donné
        before skip=0pt,
        after skip=0pt
    }
    \begin{tcolorbox}
...
\newcommand{\ProjetTitre}{Badge reader}
\newcommand{\CandidatNom}{Bernard Théoden}
\newcommand{\Promotion}{2023/2026}
\newcommand{\Entreprise}{Reds}
\newcommand{\Tuteur}{Sylvain Chavry}
\newcommand{\DateDoc}{\DTMdisplaydate{2026}{07}{09}{-}}
...
\begin{titlepage}
    ...
    \begin{tcolorbox}[
        ...
        \begin{tabular}{p{3.5cm}p{7.5cm}}
            ...
            \textbf{\mbox{Soutenance} :} & \DateDoc{} \\[0.3cm]
        \end{tabular}
    \end{tcolorbox}
