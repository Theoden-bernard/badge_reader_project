...
Dans le cadre de mon PFE j'ai decider d'utiliser Docker.
Docker permet la standardisation de l'environnement de développement et de production, garantissant la reproductibilité des déploiements.

Dans un premier temps nous avons besoin d'un Dockerfile qui nous permettera par la suite de crée une image docker.
Puis cette image nous pourons par la suite la transformer en conteneurs Docker. Le Dockerfile multi-stage optimise la taille des images en séparant les phases de build et de runtime.
\newline
