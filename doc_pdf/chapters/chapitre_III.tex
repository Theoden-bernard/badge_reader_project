...
Dans cette section, je vais vous présenter mes approche de gestion de projet entièrement centralisée sur GitHub. vous viarer ma maîtrise des outils GitHub pour la planification, le suivi et la réalisation de mon projet.
\newline

\begin{for_you}{Mon approche GitHub :}
    \textit{J'utilise GitHub pour Stocker/Partager mes projects,
    GitHub Projects pour gerer la partie organisation et verssioner et GitHub action pour automatiser certaine tache.}
\end{for_you}
...
\begin{itemize}
    ...
    \item \textbf{Rady :} Tâches prêtes pour le sprint
...
Dans cette section, je vais vous présentez mes estimation de temps pour chaque fonctionnalité et expliquer comment j'ai planifiez mon projet.
