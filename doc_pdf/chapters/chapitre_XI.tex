...
\begin{for_you}{Bilan technique et métriques}
    ...
    \begin{itemize}
        \item \textbf{Frontend} : Phoenix LiveView (temps réel, sécurité serveur).
        \item \textbf{Backend} : Elixir/Phoenix (scalabilité, concurrence).
        \item \textbf{Base de données} : PostgreSQL (données relationnelles).
...
\begin{itemize}
    \item \textbf{Technique} : Maîtrise d’Elixir/Phoenix et des bonnes pratiques DevOps.
    \item \textbf{Métier} : Compréhension des enjeux de sécurité et de gestion d’accès.
    \newline
\end{itemize}
...
\begin{for_you}{Remerciements personnalisés}
    ...
    \textbf{Aux membre du jury : \newline}
    Pour leur \textbf{temps} et leurs \textbf{pascience}, essentiels pour passer notre diplome.
