...
J’ai conçu et développé un \textbf{site de gestion de badges et d'utilisateur} pour Colint, en utilisant une architecture moderne et des outils DevOps.
\newline

\begin{for_you}{Bilan technique et métriques}
    \textbf{Architecture implémentée} :
    \begin{itemize}
        \item \textbf{Type} : MVC Monolithique.
...
\begin{for_you}{Ce que j’ai appris}
    ...
    \begin{itemize}
        \item Développer un site web \textbf{full-stack} avec Elixir/Phoenix.
    ...
    \begin{itemize}
        ...
        \item \textbf{Conception} : Perference pour le dev
        \newline
    \end{itemize}
\end{for_you}
