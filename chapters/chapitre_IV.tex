...
\begin{for_you}
    \textbf{Diagramme de case d'usage simplifié :}
    \newline
    \begin{center}
    \includegraphics[width=15cm,height=80mm]{./assets/diagramme_de_cas_d'utilisation.png}
    \end{center}
\end{for_you}
...
\newline
    \begin{center}
        \includegraphics[width=10cm,height=80mm]{./assets/diagramme_de_sequence.png}
    \end{center}
\end{for_you}
...
\begin{for_you}
\textbf{Zoning d'une page de connexion :}
\begin{center}
\includegraphics[width=15cm,height=80mm]{./assets/zoning.png}
\end{center}
\end{for_you}
...
\textbf{Vos wireframes :}

\begin{for_you}
\textbf{Wireframe - Page de connexion :}
\begin{center}
    \includegraphics[width=15cm,height=80mm]{./assets/wireframe.png}
\end{center}
\end{for_you}
...
\begin{center}
    \includegraphics[width=15cm,height=80mm]{./assets/page_de_conextion.png}
    \textbf{\newline}
\end{center}
...
\begin{for_you} \textbf{\underline{Votre palette de couleurs :}}
    \begin{itemize}
        \color{colintYellow}
        \item  Jaune 
        \color{colintBlack}
...
\begin{for_you} \textbf{\underline{Votre système typographique :}} 
    \textit{\newline J'utiliserait la police d'ecriture \underline{Farro}}
\end{for_you}
\subsubsection{Logo}

\begin{for_you} \textbf{\underline{Votre logo et son utilisation :}}
