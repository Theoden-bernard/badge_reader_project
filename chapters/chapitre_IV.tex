...
\textbf{Votre palette de couleurs :}
\begin{for_you}
    \begin{itemize}
        \color{colintYellow}
        \item  Jaune 
...
\textbf{Votre système typographique :} 
\begin{for_you}
    \textit{J'utiliserait la police d'ecriture \underline{Farro}}
\end{for_you}
\subsubsection{Logo}

\textbf{Votre logo et son utilisation :} 
\begin{for_you}
    \textit{Mon logo sera celui de colint etant donée qu'il sera utiliser pour cette ecole et qu'il sera dans le future, integrer a l'intra de Colint. Il n'y auras pas de variante de ce logo.}
\end{for_you}
