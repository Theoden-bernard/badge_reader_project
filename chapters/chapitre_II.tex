...
\textbf{Objectifs métier :} \textit{Amelioration du trafique, Protection du batiment, Plus de Confort.}

\textbf{Objectifs techniques :} \textit{Securiser le batiment, compatibilité entre les appareil, crée une interface intuitive et minimaliste}

\textbf{Objectifs pédagogiques :} \textit{\newline
1. Test unitaire \newline
2. Gestion de project et d'organisation \newline
3. Securiter (clef de chiffrement...) \newline
}
...
1. \underline{Pierre}: Il est etudiant à Colint school il viens en cours de 9h à 17h. \newline
2. \underline{Les parents de Pierre}: On un rendez vous avec le directeur et leur fils le vendredi 24 Octobre 2025.\newline
3. \underline{Maris}: Elle est coatchs à Colint school elle interviens le jeudi de 8h00 à 12h00. \newline
4. \underline{Kwame}: Il peux intervenir quand il veux aux sein de l'ecole. \newline
}
\textbf{Parties prenantes :} \textit{\newline
1. \underline{Etudiants de colint}: Il on besoins d'acceder aux batiment de 8h00 à 18h00. \newline
...
3. \underline{coatchs}: Il on besoins d'acceder aux batiment de 8h00 à 20h00. \newline
4. \underline{Administrateurs}: Il n'on aucune restrictions. \newline
}

\textbf{Matrice d'influence :} \textit{Pour chaqu'une de ses partie il on un interet comment fludifier leur trafique aux sein de l'ecole. Mais egalement securiser le batiment. Apres 18h plus aucun etudiant ne peux rentrée dans l'ecole toute sortie est définitive ce qui permet de reduir les potentiels soucis.}
...
\textbf{Vos fonctionnalités Front Office :} \textit{Pour les Inviter, Etudiants, Coatchs il ne pourrons acceder qu'a leur badge qui sera represernter sous la forme d'un QR code. Quand aux administrateurs ils aurons acces en plus a une partis pour gerer et crée les badge.}
...
\begin{for_you}
    ...
    \begin{itemize}
        ...
        \item \textbf{Statistiques :} Trace écrite des entrée sortie.
    \end{itemize}
\end{for_you}
...
\begin{for_you}
    \textbf{Typologie utilisateurs :}
    \begin{itemize}
        \item \textbf{Etudiants et coatchs :} Acces a l'app et a un Qr code avec les droit de ce dernier
        \item \textbf{Invités :} No acces a l'app mais recevera un mail avec le Qr code
...
\textbf{Vos mesures de confidentialité :}

\begin{for_you}
    \textbf{Mesures de confidentialité :}
    \begin{itemize}
...
\begin{for_you}
    ...
    \begin{center}
        \begin{tabular}{|l|l|l|l|l|}
            ...
            Coatchs & \mycross & \mycheckmark & \mycross  & \mycross \\
            Etudiants & \mycross & \mycheckmark & \mycross & \mycross \\
            Inviter & \mycross & \mycheckmark & \mycross & \mycross \\
            \hline
        \end{tabular}
    \end{center}
\end{for_you}
...
\begin{for_you}
    ...
    \begin{itemize}
        \item \textbf{Connexion :} Identifient/Mot de passe, face id...
...
\textbf{Vos choix techniques :} \textit{\newline
    ...
    En ce qui concerne Phoenix est le framework d'elicir il est donc parfait pour cette utilisation nous pouvons utiliser avec cela live vue qui est un outil pour faire du front}
\newline
...
\textbf{Votre définition du MVP :} \textit{Mon project doit être aux minimum composer d'une application. Sont rôle sera de gerer les badge des user
...
\begin{for_you}
    ...
    \begin{enumerate}
        ...
        \item Statistiques sur les entrée/sorie
