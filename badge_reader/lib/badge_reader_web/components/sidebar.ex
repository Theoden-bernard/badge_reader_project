defmodule BadgeReaderWeb.Sidebar do
  @moduledoc """
  A LiveComponent that renders the main navigation sidebar for the application.

  This component supports responsive behavior, including an expandable/collapsible
  state on desktop screens and a sliding drawer toggle for mobile devices. It also
  manages collapsible navigation menu groups (such as Users, Badges, and Settings).

  ## Features

  * **Responsive Design:** Automatically handles layouts for mobile, desktop, and widescreen resolutions.
  * **Collapsible Groups:** Dynamically tracks which navigation sections are expanded using the `open_groups` state.
  * **Active States:** Highlights links and icons based on the current active URL path.

  ## Examples

  This component can be rendered inside a layout or live view template as follows:
  ...
  def sidebar_link_group(assigns) do
    ...
    <li class={[
      ...
      {render_slot(@content, %{
        toggle: "toggle_group",
        is_open: Map.get(@open_groups, @group_id, @active_condition)
      })}
    </li>
    """
  end
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <.link navigate="/" class="block">
            <img
              src={
                if @sidebar_expanded,
                  do: "/images/colint-logo-complet.png",
                  else: "/images/colint-logo.png"
              }
              class={[
                  ...
                  <div class="flex items-center">
                    <.link navigate="/">
                      <svg
                        class={[
                          ...
                          active_icon_class(@current_path, "dashboard")
                        ]}
                    ...
                    <.link
                      ...
                      class={[
                        ...
                        active_link_class(@current_path, "dashboard")
                      ]}
                    >
                ...
                <:content :let={%{is_open: is_open}}>
                  ...
                  >
                    <div class="flex items-center">
                      <.link navigate="/users/utilisateur">
                        <svg
                          class={[
                            "shrink-0 fill-current",
                            active_icon_class(@current_path, "utilisateur")
                          ]}
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                      ...
                      <.link
                        ...
                        class={[
                          "block transition duration-150 truncate",
                          active_link_class(@current_path, "/utilisateur")
                        ]}
                      >
                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                          Utilisateur
                    ...
                    <div class="flex shrink-0 ml-2">
                      <svg
                        class={[
                          "w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 transition-transform",
                  ...
                  <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    <ul class={["pl-10 mt-1", if(is_open, do: "block", else: "hidden")]}>
                      <li class="mb-1 last:mb-0">
                        <button
                          phx-click={JS.push("trigger_modale", value: %{id: "1"})}
                      ...
                      <li class="mb-1 last:mb-0">
                        <button
                          phx-click={JS.push("trigger_modale", value: %{id: "2"})}
                          class="block transition duration-150 truncate"
                        >
                          Modifications
                        </button>
                      ...
                      <li class="mb-1 last:mb-0">
                        <button
                          phx-click={JS.push("trigger_modale", value: %{id: "3"})}
                          class="block transition duration-150 truncate"
                        >
                          Supprimer
                        </button>
                ...
                <:content :let={%{is_open: is_open}}>
                  ...
                  >
                    <div class="flex items-center">
                      ...
                      <.link
                        ...
                        class={[
                          "block transition duration-150 truncate",
                          active_link_class(@current_path, "/badge")
                        ]}
                      >
                  ...
                  <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    <ul class={["pl-8 mt-1", if(is_open, do: "block", else: "hidden")]}>
                      <li class="mb-1 last:mb-0">
                        <.link
                          navigate="/modaleCreation"
                          class={[
                            "block transition duration-150 truncate",
                            active_link_class(@current_path, "/modaleCreation")
                          ]}
                        >
                          Création
                        </.link>
                      ...
                      <li class="mb-1 last:mb-0">
                        <.link
                          ...
                          class={[
                            "block transition duration-150 truncate",
                            active_link_class(@current_path, "/modaleEdit")
                          ]}
                        >
                          Modifications
                        </.link>
                      ...
                      <li class="mb-1 last:mb-0">
                        <.link
                          navigate="/modaleDelete"
                          class={[
                            "block transition duration-150 truncate",
                            active_link_class(@current_path, "/modaleDelete")
                          ]}
                        >
                          Supprimer
                        </.link>
                    ...
                    <div class="flex items-center">
                      <.link navigate="/users/parametre">
                        <svg
                          class={[
                            "shrink-0 fill-current",
                            active_icon_class(@current_path, "parametre")
                          ]}
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                      ...
                      <.link
                        ...
                        class={[
                          "block transition duration-150 truncate",
                          active_link_class(@current_path, "/parametre")
                        ]}
                      >
                        <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                          Paramètre
                    ...
                    <ul class={["pl-8 mt-1", if(is_open, do: "block", else: "hidden")]}>
                      <li class="mb-1 last:mb-0">
                        <.link
                          ...
                          class={[
                            "block transition duration-150 truncate",
                            active_link_class(@current_path, "/profile")
                          ]}
                        >
                          <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                            Mon compte
            ...
            <ul class="mt-3">
                    ...
                    <div class="flex items-center">
                      <.link navigate="/users/authentification">
                        <svg
                          class={[
                            "shrink-0 fill-current",
                            active_icon_class(@current_path, "authentification")
                          ]}
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                      ...
                      <.link
                        ...
                        class={[
                          "block transition duration-150 truncate",
                          active_link_class(@current_path, "/authentification")
                        ]}
                      >
                        <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                          Authentification
                    ...
                    <div class="flex items-center">
                      <.link navigate="/users/evenement">
                        <svg
                          class={[
                            "shrink-0 fill-current",
                            active_icon_class(@current_path, "evenement")
                          ]}
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                      ...
                      <.link
                        ...
                        class={[
                          "block transition duration-150 truncate",
                          active_link_class(@current_path, "/evenement")
                        ]}
                      >
                        <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                          Évènement
              ...
              >
                <:content :let={%{is_open: is_open}}>
                    ...
                    <div class="flex items-center">
                      <.link navigate="/users/composants">
                        <svg
                          class={[
                            "shrink-0 fill-current",
                            active_icon_class(@current_path, "composants")
                          ]}
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                      ...
                      <.link
                        ...
                        class={[
                          "block transition duration-150 truncate",
                          active_link_class(@current_path, "/composants")
                        ]}
                      >
                        <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                          Composants
                  ...
                  <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    <ul class={["pl-8 mt-1", if(is_open, do: "block", else: "hidden")]}></ul>
                  </div>
                </:content>
              </.sidebar_link_group>
            </ul>
        ...
        <div class="pt-3 hidden lg:inline-flex 2xl:hidden justify-end mt-auto">
          <div class="w-12 pl-4 pr-3 py-2">
            ...
            >
              ...
              <svg
                class={[
                  "shrink-0 fill-current text-gray-400 dark:text-gray-500 transition-transform",
