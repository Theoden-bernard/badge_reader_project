defmodule BadgeReaderWeb.DashboardLive do
  ...
  @customers [
    %{
      id: "0",
      image: "../images/img_users/user-36-05.jpg",
      name: "Alex Shatov",
    ...
    %{
      id: "1",
      image: "/images/img_users/user-36-06.jpg",
      name: "Philip Harbach",
    ...
    %{
      id: "2",
      image: "/images/img_users/user-36-07.jpg",
      name: "Mirko Fisuk",
    ...
    %{
      id: "3",
      image: "/images/img_users/user-36-08.jpg",
      name: "Olga Semklo",
    ...
    %{
      id: "4",
      image: "/images/img_users/user-36-09.jpg",
      name: "Burak Long",
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> assign(:is_open, true)
     |> assign(:week, BadgeReader.CalculationOfTime.calculation_of_the_past_week())
     |> assign(
       :week_etudiant,
       BadgeReader.CalculationOfTime.calculation_of_the_past_week_by_role("Etudiant")
     )
     |> assign(
       :week_staff,
       BadgeReader.CalculationOfTime.calculation_of_the_past_week_by_role("Staff")
     )
  ...
  def handle_info({:new_log, _data}, socket) do
    new_week = BadgeReader.CalculationOfTime.calculation_of_the_past_week()

    send_update(BadgeReaderWeb.Dashbord.ComponentsLive.DashbordCard03,
